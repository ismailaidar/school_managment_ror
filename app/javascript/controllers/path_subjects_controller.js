...
/* This is the custom StimulusReflex controller for PathSubjectsReflex.
...
export default class extends ApplicationController {
   ...
   * Example:
   *
   *   <a href="#" data-reflex="PathSubjectsReflex#example">Example</a>
   *
   * Arguments:
   *
   ...
   *
   *   reflex - the name of the reflex e.g. "PathSubjectsReflex#example"
   *
